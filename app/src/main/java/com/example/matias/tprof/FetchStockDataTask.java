...
public class FetchStockDataTask extends AsyncTask<String, Void, Void> {
    ...
    private final String LOG_TAG = FetchStockDataTask.class.getSimpleName();

//    public FetchStockDataTask(ArrayAdapter<String> adapter) {
//        this.mQuotesAdapter = adapter;
//    }

    public FetchStockDataTask(Context context) {
        mContext = context;
    }
    ...
    protected Void doInBackground(String... params) {
        ...
        try {
            ...
            final String BASE_URL =
                    "http://10.0.2.2:50914/api/stockquotes";
