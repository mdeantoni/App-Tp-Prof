...
public class BondQuotesAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        String changeText = NumberFormat.formattedValue(cursor.getString(StockQuotesFragment.COL_LAST_CHANGE)) + " "
                + "(" + NumberFormat.formattedValue(cursor.getString(StockQuotesFragment.COL_LAST_CHANGE_PERCENTAGE)) + "%)";
        ...
        if(cursor.getDouble(BondQuotesFragment.COL_LAST_CHANGE) > 0){
        ...
        price.setText(cursor.getString(BondQuotesFragment.COL_CURRENCY) + " "+ NumberFormat.formattedValue(cursor.getString(BondQuotesFragment.COL_LAST_PRICE)));
